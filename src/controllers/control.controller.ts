...
export class ControlController {
  ...
  create = async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      return res.status(400).json({
        message:
          error instanceof Error ? error.message : "Erro ao criar Control",
      });
    }
  };
  ...
  findById = async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      return res.status(404).json({
        message:
          error instanceof Error ? error.message : "Control não encontrado",
      });
    }
  };
  ...
  findByFormId = async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      return res.status(500).json({
        message:
          error instanceof Error ? error.message : "Erro ao listar Controls",
      });
    }
  };
  ...
  update = async (req: Request, res: Response): Promise<Response> => {
    try {
      ...
      return res.status(400).json({
        message:
          error instanceof Error ? error.message : "Erro ao atualizar Control",
      });
    }
  };
